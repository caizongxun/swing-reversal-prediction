#!/usr/bin/env python3
"""
PHASE1 Direction Change Detection - Colab Version with ArgParse
...
# 例1: lookback=7, confirm_local=True
!python3 phase1.py --lookback 7 --confirm_local True

# 例2: lookback=5, confirm_local=False  
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PHASE1 Direction Change Detection',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 phase1.py --lookback 7 --confirm_local True
  python3 phase1.py --lookback 5 --confirm_local False
  python3 phase1.py --lookback 3
        """
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='输出文件名 (default: auto-generate based on parameters)'
    )
