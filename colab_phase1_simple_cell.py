# PHASE1 Direction Change Detection - Direct Cell Code
# Just copy and paste this entire code into ONE Colab cell
# Modify LOOKBACK and CONFIRM_LOCAL at the top, then run
